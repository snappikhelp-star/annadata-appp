...
import { X, Download, Share2, Plus, LayoutGrid } from "lucide-react";
  ...
  const steps = [
    {
      ...
      bg: "#007AFF",
      title: "Safari में Share दबाएं",
      sub: "नीचे toolbar में",
    },
    {
      icon: <Plus className="w-5 h-5 text-gray-700" />,
      bg: "#f0f0f0",
      title: '"Add to Home Screen" चुनें',
      sub: "List में scroll करें",
    },
    {
      icon: <LayoutGrid className="w-5 h-5 text-white" />,
      bg: "#34C759",
      title: '"Add" दबाएं',
      sub: "ऊपर-दाएं कोने में",
    },
  ];
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <div className="font-bold text-gray-800 text-sm font-hindi">
                  {s.title}
                </div>
                <div className="text-gray-500 text-xs font-hindi">
                  {s.sub}
                </div>
              </div>

              <span className="w-6 h-6 rounded-full bg-green-600 text-white text-xs font-black flex items-center justify-center flex-shrink-0">
                {i + 1}
              </span>
            </div>
          ))}
...
export default function MobileInstallNudge() {
  ...
  if (isInstalled || dismissed || platform === "standalone" || !isMobileDevice) {
    return null;
  }
        ...
        {visible && !showIOS && (
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, #0d1f0d 0%, #162d16 100%)",
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, transparent, #F9A825, transparent)",
                }}
              />
              ...
              <div className="p-4">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <span className="bg-[#F9A825] text-black text-[9px] font-black px-1.5 py-0.5 rounded-full flex-shrink-0">
                        FREE
                      </span>
                    </div>

                    <div className="text-white/50 text-xs font-hindi">
                      किसान का असली साथी — Home Screen पर
                    </div>
                  </div>

                  <button
                    onClick={dismiss}
                    className="text-white/30 p-1 flex-shrink-0 -mt-0.5"
                  >
                    <X className="w-4 h-4" />
                  </button>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {[
                    ...
                    >
                      ...
                      <span className="text-white/70 text-[10px] font-bold leading-tight whitespace-pre-line">
                        {b.text}
                      </span>
                    </div>
                  ))}
                ...
                {installed ? (
                  <div className="flex items-center justify-center gap-2 py-3.5 bg-green-600/20 rounded-2xl border border-green-500/30">
                    ...
                    <span className="text-green-300 font-bold text-sm font-hindi">
                      App Install हो गया!
                    </span>
                  </div>
                ) : (
                  <div className="flex gap-2">
                    <button
                      ...
                      style={{
                        background:
                          "linear-gradient(135deg, #F9A825 0%, #f5b014 100%)",
                        color: "#0d1f0d",
                      ...
                      {installing ? (
                        ...
                        <>
                          ...
                          <span className="font-hindi">
                            iPhone पर Install करें
                          </span>
                        </>
                      ) : (
                        <>
                          <Download className="w-4 h-4" />
                          <span className="font-hindi">App Install करें</span>
                        </>
                      )}
                    </button>
